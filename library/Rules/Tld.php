...
final class Tld extends AbstractRule
{
    ...
    private const TLD_LIST = [
        ...
        'LANCIA', 'LAND', 'LANDROVER', 'LANXESS', 'LASALLE', 'LAT', 'LATINO',
        ...
        'MTN', 'MTR', 'MU', 'MUSEUM', 'MUSIC', 'MUTUAL', 'MV', 'MW', 'MX',
        'MY', 'MZ', 'NA', 'NAB', 'NAGOYA', 'NAME', 'NATURA', 'NAVY', 'NBA',
        ...
        'OBSERVER', 'OFFICE', 'OKINAWA', 'OLAYAN', 'OLAYANGROUP', 'OLDNAVY',
